...
\author{
\begin{tabular}{rl}
\textbf{Bisiaux} Alexandre& \textit{(Rédacteur)} \\
\textbf{Guihal} Maxime& \textit{(Rédacteur, relecteur)} \\
\textbf{Guillermic} Brice& \textit{(Rédacteur)} \\
\textbf{Rousseau} Simon& \textit{(Rédacteur, relecteur)}
\end{tabular}
}
\location{Nantes}
\blurb{%
