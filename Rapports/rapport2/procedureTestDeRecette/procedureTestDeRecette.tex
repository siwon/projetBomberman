...
\author{
\begin{tabular}{rl}
\textbf{Bisiaux} Alexandre& \textit{\small{(Rédacteur)}} \\
\textbf{Guihal} Maxime& \textit{\small{(Rédacteur, relecteur)}} \\
\textbf{Guillermic} Brice& \textit{\small{(Rédacteur)}} \\
\textbf{Rousseau} Simon& \textit{\small{(Rédacteur, relecteur)}}
\end{tabular}
}
\location{Nantes}
\blurb{%
