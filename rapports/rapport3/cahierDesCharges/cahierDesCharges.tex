...
\makeatletter
\newcommand{\nbSecondes}{3 }%temps pour les infections
\newcommand{\longueurMeche}{3 }%temps pour les infections
...
\makeatother
\title{Projet Bomberman \\\Large{\textit{Cahier des charges technique - Conception}}}
\author{\begin{tabular}{rl}\textbf{Bisiaux} Alexandre& \textit{\small{(Rédacteur)}} \\\textbf{Guihal} Maxime& \textit{\small{(Rédacteur, relecteur)}} \\\textbf{Guillermic} Brice& \textit{\small{(Rédacteur)}} \\\textbf{Rousseau} Simon& \textit{\small{(Rédacteur, relecteur)}}\end{tabular}}
\location{Nantes}
\blurb{%
