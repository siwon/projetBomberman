...
\author{\begin{tabular}{rl}\textbf{Bisiaux} Alexandre& \textit{\small{(Relecteur)}} \\\textbf{Guihal} Maxime& \textit{\small{(Rédacteur)}} \\\textbf{Guillermic} Brice& \textit{\small{(Rédacteur)}} \\\textbf{Rousseau} Simon& \textit{\small{(Relecteur)}}\end{tabular}}
\location{Nantes}
\blurb{%
